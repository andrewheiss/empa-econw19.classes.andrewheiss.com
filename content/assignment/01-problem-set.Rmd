...
**NOTE**: We'll cover how to deal with compound annual interest at the beginning of class 2. The instructions for doing this are in ESPP—ESPP calls this the CAGR, and they include instructions in section 1.2. If you want to try it without an in-class example, you can also [look at the lab for the daytime students for an example of how to do this](https://econw19.classes.andrewheiss.com/class/01-lab/#compounding-inflation).

Download this dataset^[Source: ESPP. All numbers expressed in 1990 international USD (i.e. they're all real; you don't need to adjust for inflation or anything).]:

- [<i class="fas fa-file-excel"></i> `global_income_raw.xlsx`](/data/global_income_raw.xlsx)

1. Calculate the compound annual growth rate^[ESPP calls this the CAGR.] for China, Britain, Italy, and India for the years 1750–1850, 1851–1950, and 1951–2014.
...
Download this dataset^[Source: [FRED](https://fred.stlouisfed.org/). [See the R code I used to download and process this data](https://econw19.classes.andrewheiss.com/class/02-class/#economic-indicators).]:
